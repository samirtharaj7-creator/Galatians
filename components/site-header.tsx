...
const links = [
  ...
  { href: "/galatians/1", label: "Commentary", active: (pathname: string) => pathname.startsWith("/galatians") },
...
export function SiteHeader() {
  ...
  return (
    <header className="reader-header no-print">
      <Link href="/" className="reader-brand" aria-label="Galatians Commentary Home">
        ...
        <span className="reader-brand-text">
          <span className="reader-brand-strong">Galatians Commentary</span>
        </span>
      </Link>
