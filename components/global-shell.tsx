const libraryItems = [
  ...
  { name: "Galatians", description: "Freedom in Christ and life by the Spirit", href: "/", category: "book", current: true },
...
export function GlobalShell() {
  return (
    <header className="mbe-global-shell" data-tool="galatians" data-embedded="true">
...
export function GlobalFooter() {
  return (
    <footer className="mbe-global-footer" data-tool="galatians">
